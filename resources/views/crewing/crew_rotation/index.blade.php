                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    ...
                                    <div class="d-flex gap-2 align-items-center">
                                        <a href="{{ route('crew_rotation.create') }}" class="btn btn-primary px-5 py-2 mb-3 me-2"><i class="bi bi-plus"></i> Tambah</a>
                                    </div>
                                </div>
                                ...
                                <table class="table datatable table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ asset('userdata/crew_rotation/'.$item->file) }}" target="_blank" class="">{{ $item->file }}</a>
                                            </td>
