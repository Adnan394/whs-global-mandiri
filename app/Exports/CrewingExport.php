...
class CrewingExport implements FromCollection, WithHeadings
{
    protected $filters;

    // 🔹 Constructor agar bisa terima filter dari controller
    ...
    public function collection()
    {
        ...
        // 🔸 Filter status (Onboard / Offboard)
